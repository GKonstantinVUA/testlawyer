(() => {
    ...
    class Popup {
        ...
        eventsPopup() {
            document.addEventListener("click", function(e) {
                ...
                const curtailLink = e.target.closest(".body-card__curtail");
                if (curtailLink) {
                    e.preventDefault();
                    this.close();
                    return;
    ...
    //! Функционал для бургер меню
        ...
        if (markerLink && document.documentElement.classList.contains("menu-open")) {
            e.preventDefault();
            const submenu = markerLink.nextElementSibling;
            if (submenu && submenu.classList.contains("submenu")) {
                ...
                if (!isActive) {
                    ...
                    markerLink.classList.add("active");
                }
            }
        }
    }));
    //! Наблюдатель для Контроля анимации
